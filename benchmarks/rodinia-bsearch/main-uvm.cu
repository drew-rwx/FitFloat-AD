...
int main(int argc, char* argv[])
{
  ...
  Real_t* d_z;
  size_t *d_r;
  cudaMallocManaged((void**)&d_a, sizeof(Real_t)*aSize);
  cudaMallocManaged((void**)&d_z, sizeof(Real_t)*zSize);
  cudaMallocManaged((void**)&d_r, sizeof(size_t)*zSize);
  cudaMemcpy(d_a, a, sizeof(Real_t)*aSize, cudaMemcpyHostToHost);
  cudaMemcpy(d_z, z, sizeof(Real_t)*zSize, cudaMemcpyHostToHost);
