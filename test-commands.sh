...
nvcc -O3 -Xcompiler -fopenmp -arch=$GPU_ARCH -DBITS_FOR_EXPONENT_32=8 -DBITS_FOR_MANTISSA_32=23 -DUVM1 "$CODE_DIR/$NATIVE_SRC" -o fitflt
nsys profile --stats=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true --show-output=true ./fitflt

nvcc -O3 -Xcompiler -fopenmp -arch=$GPU_ARCH -DBITS_FOR_EXPONENT_32=8 -DBITS_FOR_MANTISSA_32=19 -DUVM1 "$CODE_DIR/$NATIVE_SRC" -o fitflt
nsys profile --stats=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true --show-output=true ./fitflt

nvcc -O3 -Xcompiler -fopenmp -arch=$GPU_ARCH -DBITS_FOR_EXPONENT_32=8 -DBITS_FOR_MANTISSA_32=15 -DUVM1 "$CODE_DIR/$NATIVE_SRC" -o fitflt
nsys profile --stats=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true --show-output=true ./fitflt

nvcc -O3 -Xcompiler -fopenmp -arch=$GPU_ARCH -DBITS_FOR_EXPONENT_32=8 -DBITS_FOR_MANTISSA_32=11 -DUVM1 "$CODE_DIR/$NATIVE_SRC" -o fitflt
nsys profile --stats=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true --show-output=true ./fitflt

nvcc -O3 -Xcompiler -fopenmp -arch=$GPU_ARCH -DBITS_FOR_EXPONENT_32=4 -DBITS_FOR_MANTISSA_32=12 -DUVM1 "$CODE_DIR/$NATIVE_SRC" -o fitflt
nsys profile --stats=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true --show-output=true ./fitflt
