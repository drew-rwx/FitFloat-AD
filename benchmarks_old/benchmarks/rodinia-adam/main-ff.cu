...
int main(int argc, char* argv[])
{
  ...
  FFArr32 d_m(vector_size);
  FFArr32 d_v(vector_size);
  FFArr32 d_g(vector_size);
  FFArr32 d_p(vector_size);

  FloatH2FFDmemcpy(d_m, m, vector_size);
  FloatH2FFDmemcpy(d_v, v, vector_size);
  FloatH2FFDmemcpy(d_g, g, vector_size);
  FloatH2FFDmemcpy(d_p, p, vector_size);
